...
plot_ly(data = daily_data_23, x = ~Date, type = 'scatter', mode = 'lines+markers', 
  ...
  layout(title = "Daily Dengue Cases Pattern in 2023", 
...
plot_ly(data = monthly_data_23, x = ~Month, type = 'scatter', mode = 'lines+markers', 
  ...
  layout(title = "Monthly Dengue Cases Pattern in 2023", 
         xaxis = list(title = 'Date'),
         yaxis = list(title = 'Cases'), 
         legend = list(orientation = "h", 
                       xanchor = "center", 
...
```{r}
# Viz 3: Number of Dengue Cases in 2023
plot_ly(data = data23, x = ~Months)  |> 
  ...
  layout(title = "Monthly Dengue Cases in 2023",
...
plot_ly(data = data23, x = ~Months) |> 
  ...
  layout(title = "Monthly Dengue Deaths in 2023",
         xaxis = list(title = 'Month'),
