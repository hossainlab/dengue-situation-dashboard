...
```{r, bd-overview-load-data, include=FALSE}
# daily data for 2023 
...
highchart()  |> 
  ...
  hc_title(text = 'Seasonality of dengue outbreaks in Bangladesh in 2023',
           style = list(fontSize = '25px', 
                        fontWeight = 'bold')) |>
  hc_subtitle(text = 'By Month', 
              style = list(fontSize = '16px')) |> 
  hc_add_theme(hc_theme_google())
```

### Number of Dengue Cases by Month in 2023
```{r, bd-overview-monthly-cases}
...
highchart()  |> 
  ...
  hc_title(text = 'Seasonality of dengue outbreaks in Bangladesh in 2023',
           style = list(fontSize = '25px', 
                        fontWeight = 'bold')) |>
  hc_subtitle(text = 'The number of reported death death cases by DGHS', 
              style = list(fontSize = '16px')) |> 
  hc_add_theme(hc_theme_google())
```
